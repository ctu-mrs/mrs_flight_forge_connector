...
PYBIND11_MODULE(flight_forge_drone, m) {
  ...
  py::class_<UedsConnector>(m, "DroneController")
      ...
      .def("ConnectSimple", &UedsConnector::ConnectSimple)
      .def("Ping", &UedsConnector::Ping)
      .def("Disconnect", &UedsConnector::Disconnect)
      .def("GetLocation", &UedsConnector::GetLocation)
      .def("GetCrashState", &UedsConnector::GetCrashState)
      .def("SetLocation", &UedsConnector::SetLocation)
      .def("GetRotation", &UedsConnector::GetRotation)
      .def("SetRotation", &UedsConnector::SetRotation)
      .def("SetLocationAndRotation", &UedsConnector::SetLocationAndRotation)
      .def("SetLocationAndRotationAsync", &UedsConnector::SetLocationAndRotationAsync)
      .def("GetMoveLineVisible", &UedsConnector::GetMoveLineVisible)
      .def("SetMoveLineVisible", &UedsConnector::SetMoveLineVisible)
      .def("GetRgbCameraData", &UedsConnector::GetRgbCameraData, py::arg("sensor_id") = -1)
      .def("GetStereoCameraData", &UedsConnector::GetStereoCameraData, py::arg("sensor_id") = -1)
      .def("GetRgbSegmented", &UedsConnector::GetRgbSegmented, py::arg("sensor_id") = -1)
      .def("GetRgbCameraConfig", &UedsConnector::GetRgbCameraConfig, py::arg("sensor_id") = -1)
      .def("SetRgbCameraConfig", &UedsConnector::SetRgbCameraConfig, py::arg("config"), py::arg("sensor_id") = -1)
      .def("GetStereoCameraConfig", &UedsConnector::GetStereoCameraConfig, py::arg("sensor_id") = -1)
      .def("SetStereoCameraConfig", &UedsConnector::SetStereoCameraConfig, py::arg("config"), py::arg("sensor_id") = -1)
      .def("GetEventCameraData", &UedsConnector::GetEventCameraData, py::arg("sensor_id") = -1)
      .def("GetEventCameraConfig", &UedsConnector::GetEventCameraConfig, py::arg("sensor_id") = -1)
      .def("SetEventCameraConfig", &UedsConnector::SetEventCameraConfig, py::arg("config"), py::arg("sensor_id") = -1)
      .def("GetFisheyeCameraData", &UedsConnector::GetFisheyeCameraData, py::arg("sensor_id") = -1)
      .def("GetFisheyeCameraConfig", &UedsConnector::GetFisheyeCameraConfig, py::arg("sensor_id") = -1)
      .def("SetFisheyeCameraConfig", &UedsConnector::SetFisheyeCameraConfig, py::arg("config"), py::arg("sensor_id") = -1)
      .def("GetRangefinderData", &UedsConnector::GetRangefinderData, py::arg("sensor_id") = -1)
      .def("GetLidarData", &UedsConnector::GetLidarData, py::arg("sensor_id") = -1)
      .def("GetLidarSegData", &UedsConnector::GetLidarSegData, py::arg("sensor_id") = -1)
      .def("GetLidarIntData", &UedsConnector::GetLidarIntData, py::arg("sensor_id") = -1)
      .def("GetLidarConfig", &UedsConnector::GetLidarConfig, py::arg("sensor_id") = -1)
      .def("SetLidarConfig", &UedsConnector::SetLidarConfig, py::arg("config"), py::arg("sensor_id") = -1)
      .def("AddSensor", &UedsConnector::AddSensor)
      .def("RemoveSensor", &UedsConnector::RemoveSensor)
      .def("ListSensors", &UedsConnector::ListSensors)
      .def("AddDevice", &UedsConnector::AddDevice, py::arg("device_name"), py::arg("offset"), py::arg("rotation"), py::arg("show_mesh") = true)
      .def("ListDevices", &UedsConnector::ListDevices);
